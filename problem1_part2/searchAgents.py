...
def chebyshevHeuristic(position, problem, info={}):
    ...
    return chebyshevDistance(position, problem.goal)
...
def chebyshevDistance(point1,point2):
    ...
    This heuristic works well for grid-based pathfinding where diagonal moves are allowed.

    :param x1, y1: Coordinates of the current position.
    :param x2, y2: Coordinates of the goal position.
